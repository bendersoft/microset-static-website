                ...
                <div className="absolute left-0 mt-2 w-60 bg-gray-700 shadow-lg rounded-lg py-2">
                  <div className="space-y-2  mx-3 border-l-2 border-cyan-400">
                    ...
                    >
                      ...
                      <span className="block text-sm text-gray-400">Solutions d'automatisation industrielle</span>
                    </Link>
                    <Link
                      to="/industries"
                      onClick={closeMenus}
                    ...
                    >
                      ...
                      <span className="block text-sm text-gray-400">Solutions électroniques industrielles</span>
                    </Link>
                    <Link
                      to="/industries"
                      onClick={closeMenus}
                    ...
                    >
                      ...
                      <span className="block text-sm text-gray-400">Solutions logicielles industrielles</span>
                    </Link>
                  </div>
                </div>
              )}
              ...
              {openDropdown === "vinicole" && (
                <div className="absolute left-0 mt-2 w-60 bg-gray-700 shadow-lg rounded-lg py-2">
                  <div className="space-y-2 mx-3 border-l-2 border-cyan-400">
                    ...
                    >
                      <span className="block font-medium">Caves intelligentes</span>
                      <span className="block text-sm text-gray-400">Solutions de caves intelligentes</span>
                    </Link>
                    <Link
                      to="/vinicole"
                      onClick={closeMenus}
                    ...
                    >
                      ...
                      <span className="block text-sm text-gray-400">Solutions de traçabilité</span>
                    </Link>
                    <Link
                      to="/vinicole"
                      onClick={closeMenus}
                    ...
                    >
                      ...
                      <span className="block text-sm text-gray-400">Solutions d'analyse qualité</span>
                    </Link>
                  </div>
                </div>
              )}
