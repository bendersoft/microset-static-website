...
const IndusAutomatisme = () => {
  const presentation = {
    ...
    content: "Nous assurons la réalisation de vos automatismes, de la conception de vos schématiques électrique ou mécanique à la maintenance de vos équipements."
  }
  const cards = [
    {
		id: 1,
