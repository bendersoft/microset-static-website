...
const IndusInformatique = () => {
	const presentation = {
		...
		content:
			"WinProcess est un progiciel destiné au pilotage d'autoclaves et d'étuves (programmation, contrôle, acquisition de mesures de pression, de température et de vide).",
	};
	const cards = [
		{
			id: 1,
			...
			subtitle:
				"WinProcess est une application destinée à la conduite d'autoclaves.",
			content: [
				"Pilotage",
				"Régulation",
				"Enregistrement",
