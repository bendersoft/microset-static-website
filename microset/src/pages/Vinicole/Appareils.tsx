...
const Appareils = () => {
	const presentation = {
		...
		subtitle: "Appareils",
		content:
			"MICROSET ing. vous apporte les solutions pour toute vente, installation et maintenance de vos matériels vinicoles, afin d'améliorer votre qualité et votre productivité.",
	};
	const cards = [
		{
