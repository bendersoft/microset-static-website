...
const ViniAutomatisme = () => {
	const presentation = {
		...
		content:
			"MICROSET ing. est spécialiste dans la gestion complète d'un poste de réception de vendanges (commande et puissance électrique). Il assure également les mesures Qualité (appareils d'échantillonnage, carotteuses, stations Qualité, réfractomètres…).",
	};
	const cards = [
		{
